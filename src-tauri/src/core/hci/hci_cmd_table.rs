...
pub fn lookup(ogf: u8, ocf: u16) -> Option<&'static HciCmdDef> {
    if let Some(def) = FIXUPS.iter().find(|c| c.ogf == ogf && c.ocf == ocf) {
        return Some(def);
    }
    TABLE.iter().find(|c| c.ogf == ogf && c.ocf == ocf)
}

// Bluetooth 5.x+ LE Controller commands whose OCFs were missing or shifted in
// the original table. Keep these first so lookup() overrides stale entries.
static FIXUPS: &[HciCmdDef] = &[
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0013,
    ...
    HciCmdDef {
        ...
        params: &[("Channel_Map", ParamType::Bytes(5))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0015,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x001A,
        name: "LE_Long_Term_Key_Request_Reply",
        params: &[
            ("Connection_Handle", ParamType::U16),
            ("Long_Term_Key", ParamType::Bytes(16)),
        ],
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x001B,
        name: "LE_Long_Term_Key_Request_Negative_Reply",
        params: &[("Connection_Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x001D,
        name: "LE_Receiver_Test_V1",
        params: &[("RX_Channel", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x001E,
        name: "LE_Transmitter_Test_V1",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0023,
        name: "LE_Read_Suggested_Default_Data_Length",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0024,
        name: "LE_Write_Suggested_Default_Data_Length",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0025,
        name: "LE_Read_Local_P256_Public_Key",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0026,
        name: "LE_Generate_DHKey_V1",
        params: &[("Remote_P256_Public_Key", ParamType::Bytes(64))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0027,
        name: "LE_Add_Device_To_Resolving_List",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0028,
        name: "LE_Remove_Device_From_Resolving_List",
        params: &[
            ("Peer_Identity_Address_Type", ParamType::U8),
            ("Peer_Identity_Address", ParamType::BdAddr),
        ],
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0029,
        name: "LE_Clear_Resolving_List",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002A,
        name: "LE_Read_Resolving_List_Size",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002B,
        name: "LE_Read_Peer_Resolvable_Address",
        params: &[
            ("Peer_Identity_Address_Type", ParamType::U8),
            ("Peer_Identity_Address", ParamType::BdAddr),
        ],
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002C,
        name: "LE_Read_Local_Resolvable_Address",
        params: &[
            ("Peer_Identity_Address_Type", ParamType::U8),
            ("Peer_Identity_Address", ParamType::BdAddr),
        ],
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002D,
        name: "LE_Set_Address_Resolution_Enable",
        params: &[("Address_Resolution_Enable", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002E,
        name: "LE_Set_Resolvable_Private_Address_Timeout",
        params: &[("RPA_Timeout", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x002F,
        name: "LE_Read_Maximum_Data_Length",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ...
        params: &[
            ...
            ("Advertising_Set_Parameters", ParamType::Bytes(0)),
        ],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ...
        params: &[("Advertising_Handle", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x003D,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x004F,
        name: "LE_Receiver_Test_V3",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0050,
        name: "LE_Transmitter_Test_V3",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0051,
        name: "LE_Set_Connectionless_CTE_Transmit_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0052,
        name: "LE_Set_Connectionless_CTE_Transmit_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0053,
        name: "LE_Set_Connectionless_IQ_Sampling_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0054,
        name: "LE_Set_Connection_CTE_Receive_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0055,
        name: "LE_Set_Connection_CTE_Transmit_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0056,
        name: "LE_Connection_CTE_Request_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0057,
        name: "LE_Connection_CTE_Response_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0058,
        name: "LE_Read_Antenna_Information",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ...
        params: &[("Sync_Handle", ParamType::U16), ("Enable", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005A,
        name: "LE_Periodic_Advertising_Sync_Transfer",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005B,
        name: "LE_Periodic_Advertising_Set_Info_Transfer",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005C,
        name: "LE_Set_Periodic_Advertising_Sync_Transfer_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005D,
        name: "LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005E,
        name: "LE_Generate_DHKey_V2",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x005F,
        name: "LE_Modify_Sleep_Clock_Accuracy",
        params: &[("Action", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0060,
        name: "LE_Read_Buffer_Size_V2",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ...
        ocf: 0x0064,
        name: "LE_Create_CIS",
        params: &[("CIS_Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0065,
        name: "LE_Remove_CIG",
        params: &[("CIG_ID", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0066,
    ...
    HciCmdDef {
        ...
        params: &[("BIG_Handle", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x006D,
    ...
    HciCmdDef {
        ...
        params: &[("Bit_Number", ParamType::U8), ("Bit_Value", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0075,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0076,
        name: "LE_Enhanced_Read_Transmit_Power_Level",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0077,
        name: "LE_Read_Remote_Transmit_Power_Level",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0078,
        name: "LE_Set_Path_Loss_Reporting_Parameters",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0079,
        name: "LE_Set_Path_Loss_Reporting_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x007A,
        name: "LE_Set_Transmit_Power_Reporting_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x007B,
        name: "LE_Transmitter_Test_V4",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x007C,
        name: "LE_Set_Data_Related_Address_Changes",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x007D,
        name: "LE_Set_Default_Subrate",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x007E,
        name: "LE_Subrate_Request",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0087,
        name: "LE_Read_All_Local_Supported_Features",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0088,
        name: "LE_Read_All_Remote_Features",
        params: &[("Connection_Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ...
        params: &[("Channel_Classification", ParamType::Bytes(10))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0093,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0094,
        name: "LE_CS_Set_Procedure_Enable",
        params: &[("Parameters", ParamType::Bytes(0))],
    },
    HciCmdDef {
        ogf: 0x08,
...
static TABLE: &[HciCmdDef] = &[
    ...
    HciCmdDef {
        ...
        params: &[("BD_ADDR", ParamType::BdAddr), ("Role", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x01,
        ocf: 0x000A,
        name: "Reject_Connection_Request",
        params: &[("BD_ADDR", ParamType::BdAddr), ("Reason", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x01,
        ocf: 0x000B,
    ...
    HciCmdDef {
        ogf: 0x02,
        ocf: 0x000E,
        name: "Read_Default_Link_Policy_Settings",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x02,
        ocf: 0x000F,
        name: "Write_Default_Link_Policy_Settings",
        params: &[("Link_Policy_Settings", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x02,
        ocf: 0x0010,
        name: "Flow_Specification",
        params: &[
            ("Connection_Handle", ParamType::U16),
            ("Flags", ParamType::U8),
    ...
    HciCmdDef {
        ...
        ocf: 0x0001,
        name: "Set_Event_Mask",
        params: &[("Event_Mask", ParamType::Bytes(8))],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0003,
    ...
    HciCmdDef {
        ...
        params: &[("Local_Name", ParamType::Bytes(248))],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x000D,
        name: "Read_Stored_Link_Key",
        params: &[("BD_ADDR", ParamType::BdAddr), ("Read_All", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x000E,
        name: "Delete_Stored_Link_Key",
        params: &[
            ("BD_ADDR", ParamType::BdAddr),
    ...
    HciCmdDef {
        ...
        params: &[("Conn_Accept_Timeout", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0010,
        name: "Read_Connection_Accept_Timeout",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0011,
        name: "Read_Page_Timeout",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0013,
        name: "Read_Inquiry_Scan_Activity",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0015,
        name: "Read_Authentication_Enable",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0016,
        name: "Write_Authentication_Enable",
        params: &[("Authentication_Enable", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0017,
    ...
    HciCmdDef {
        ...
        params: &[("Page_Timeout", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0019,
        name: "Read_Scan_Enable",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ...
        params: &[("Scan_Enable", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x001B,
        name: "Read_Class_of_Device",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ...
        params: &[("Class_of_Device", ParamType::U24)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x001D,
        name: "Read_Voice_Setting",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x001E,
        name: "Write_Voice_Setting",
        params: &[("Voice_Setting", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0023,
        name: "Read_Page_Scan_Type",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ...
        params: &[("Page_Scan_Type", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0025,
        name: "Read_Inquiry_Scan_Type",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ...
        params: &[("Inquiry_Scan_Type", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0027,
        name: "Read_Inquiry_Mode",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0028,
        name: "Write_Inquiry_Mode",
        params: &[("Inquiry_Mode", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0029,
        name: "Read_Page_Scan_Mode",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002A,
        name: "Write_Page_Scan_Mode",
        params: &[("Page_Scan_Mode", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002B,
        name: "Read_Auto_Flush_Timeout",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002C,
        name: "Write_Auto_Flush_Timeout",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002D,
        name: "Read_Num_Broadcast_Retransmissions",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002E,
        name: "Write_Num_Broadcast_Retransmissions",
        params: &[("Num_Broadcast_Retransmissions", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x002F,
        name: "Read_Hold_Mode_Activity",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0030,
        name: "Write_Hold_Mode_Activity",
        params: &[("Hold_Mode_Activity", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0031,
        name: "Read_Transmit_Power_Level",
        params: &[("Handle", ParamType::U16), ("Type", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0032,
        name: "Read_Synchronous_Flow_Control_Enable",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0035,
        name: "Read_Link_Supervision_Timeout",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0036,
        name: "Write_Link_Supervision_Timeout",
        params: &[
            ("Handle", ParamType::U16),
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0037,
        name: "Read_Number_Of_Supported_IAC",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0038,
        name: "Read_Current_IAC_LAP",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0039,
        name: "Write_Current_IAC_LAP",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0045,
        name: "Read_Inquiry_Response_Power_Level",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0046,
        name: "Write_Inquiry_Transmit_Power_Level",
        params: &[("TX_Power_Level", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0047,
        name: "Read_Default_Erroneous_Data_Reporting",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0051,
        name: "Enhanced_Flush",
        params: &[("Handle", ParamType::U16), ("Packet_Type", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0052,
        name: "Write_Extended_Inquiry_Response",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0060,
        name: "Send_Keypress_Notification",
        params: &[
            ("BD_ADDR", ParamType::BdAddr),
    ...
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0055,
        name: "Set_Event_Mask_Page_2",
        params: &[("Event_Mask_Page_2", ParamType::Bytes(8))],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0056,
        name: "Write_Simple_Pairing_Mode",
        params: &[("Simple_Pairing_Mode", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0057,
        name: "Read_Local_OOB_Data",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0058,
        name: "Read_Flow_Control_Mode",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0063,
        name: "Read_Secure_Connections_Host_Support",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x0064,
        name: "Write_Secure_Connections_Host_Support",
        params: &[("Secure_Connections_Host_Support", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x006C,
        name: "Read_Authenticated_Payload_Timeout",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x03,
        ocf: 0x006D,
        name: "Write_Authenticated_Payload_Timeout",
        params: &[
            ("Handle", ParamType::U16),
    ...
    HciCmdDef {
        ogf: 0x04,
        ocf: 0x0004,
        name: "Read_Local_Extended_Features",
        params: &[("Page_Number", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x04,
        ocf: 0x0005,
    ...
    HciCmdDef {
        ogf: 0x04,
        ocf: 0x000A,
        name: "Read_Data_Block_Size",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x04,
        ocf: 0x000B,
        name: "Read_Local_Supported_Codecs_V1",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x04,
        ocf: 0x000D,
        name: "Read_Local_Supported_Codecs_V2",
        params: &[],
    },
    ...
    HciCmdDef {
        ogf: 0x05,
        ocf: 0x0001,
        name: "Read_Failed_Contact_Counter",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x05,
        ocf: 0x0002,
        name: "Reset_Failed_Contact_Counter",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x05,
        ocf: 0x0003,
        name: "Read_Link_Quality",
        params: &[("Handle", ParamType::U16)],
    },
    HciCmdDef {
        ogf: 0x05,
    ...
    HciCmdDef {
        ...
        ocf: 0x0007,
        name: "Read_Clock",
        params: &[("Handle", ParamType::U16), ("Which_Clock", ParamType::U8)],
    },
    // OGF=0x06 Testing
    HciCmdDef {
        ogf: 0x06,
    ...
    HciCmdDef {
        ...
        params: &[("Loopback_Mode", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x06,
        ocf: 0x0003,
        name: "Enable_Device_Under_Test_Mode",
        params: &[],
    },
    ...
    HciCmdDef {
        ...
        params: &[("LE_Event_Mask", ParamType::Bytes(8))],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0002,
        name: "LE_Read_Buffer_Size_V1",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
    ...
    HciCmdDef {
        ...
        params: &[("Random_Address", ParamType::BdAddr)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0006,
    ...
    HciCmdDef {
        ...
        params: &[("Advertising_Enable", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x000B,
    ...
    HciCmdDef {
        ...
        ocf: 0x003E,
        name: "LE_Set_Extended_Advertising_Enable",
        params: &[("Enable", ParamType::U8), ("Num_Sets", ParamType::U8)],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x003F,
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0047,
        name: "LE_Add_Device_To_Periodic_Advertiser_List",
        params: &[
            ("Advertiser_Address_Type", ParamType::U8),
            ("Advertiser_Address", ParamType::BdAddr),
            ("Advertising_SID", ParamType::U8),
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0048,
        name: "LE_Remove_Device_From_Periodic_Advertiser_List",
        params: &[
            ("Advertiser_Address_Type", ParamType::U8),
            ("Advertiser_Address", ParamType::BdAddr),
            ("Advertising_SID", ParamType::U8),
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0049,
        name: "LE_Clear_Periodic_Advertiser_List",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x004A,
        name: "LE_Read_Periodic_Advertiser_List_Size",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x004B,
        name: "LE_Read_Transmit_Power",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x004C,
        name: "LE_Read_RF_Path_Compensation",
        params: &[],
    },
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x004D,
        name: "LE_Write_RF_Path_Compensation",
        params: &[
    ...
    HciCmdDef {
        ogf: 0x08,
        ocf: 0x0068,
        name: "LE_Extended_Create_Connection_V2",
        params: &[
